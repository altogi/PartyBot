...
class WatsonIntegrator:
    ...
    """
    def __init__(self, console, api_key='6QwkLfZzI3h-Jq0nSDFwLTLucDKwD4WXu_cYSmzHp0IR', version='2020-09-24', service_url='https://api.eu-de.assistant.watson.cloud.ibm.com', assistant_id='49257b13-bd2b-405a-89ed-1e0e45f1f05e'):
        ...
        self.console = console #Interaction with user console
        ...
        for r in response:
            if r['response_type'] == 'option':
                ...
                for i, o in enumerate(options):
                    if numeric:
                        self.console.print('   ' + str(i + 1) + '. ' + o['label'])
                    else:
                        self.console.print('   ' + o['label'])
